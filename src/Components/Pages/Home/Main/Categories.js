...
const Categories = () => {
    return (
        <div className="container border bg-white px-lg-3 pb-lg-3 ps-xl-5 pb-3 pt-0 d-flex flex-column justify-content-center align-items-center my-5">
            <h3 className="p-3 bg-white rounded border shadow text-muted mb-4" style={{marginTop: "-1.5rem"}}>Shop by category</h3>
            <div className="rounded border p-2 w-100">
                <div className="row justify-content-center">
                    ...
                    <div className="col-12 col-sm-7 col-md-8 col-lg-5 col-xl-6">
                        ...
                        >
                            <img className="rounded" src={clothcarousel} alt="" />
                            <img className="rounded" src={clothcarousel} alt="" />
                            <img className="rounded" src={clothcarousel} alt="" />
                        </Slider>

                        <div className="row row-cols-4 gx-3 w-100 mx-0 my-2 p-3">
                            <div className="col">
                                <div className="border shadow-sm bg-white p-1 rounded">
                                    <img src={clothcarousel} alt="" width="100%" height="80px"/>
                                </div>
                            </div>
                            <div className="col">
                                <div className="border shadow-sm bg-white p-1 rounded">
                                    <img src={item1} alt="" width="100%" height="80px"/>
                                </div>
