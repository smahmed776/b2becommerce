                                        ...
                                        <div className="col-12">
                                            <div className="d-flex justify-content-between py-2">
                                                <div className="border-end pe-3">
                                                    {Rating(3)} <small className="text-primary">100 reviews</small>
                                                </div>
                                            ...
                                            <div className="d-flex justify-content-start py-2">
                                                ...
                                                <small className="text-primary border-end px-2 me-2">BGL</small>
                                                <small className="text-primary">More product from Bigly</small>
                                            </div>
                                            <hr />
                                        </div>
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="px-4">
                                                    <h4 className="m-0 text-primary">
                                                        <span className="pe-2">$100</span>-<span className="ps-2">$200</span>
                                                    </h4>
                                                    <p className="m-0">
