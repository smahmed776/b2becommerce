                ...
                <div className="border rounded bg-white">
                    ...
                    <div className="row row-cols-1 gy-2 w-100 m-0">
                        <div className="col d-flex justify-content-between p-0">
                            <h6 className="text-muted p-3 d-inline">Product details of Korean womens high end Laptot 499HDD 8gb ram corei7 processor 10th generation</h6>
                        ...
                        <div className="col px-3">
                            <h6>Description: </h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et ad, delectus porro esse odio
                                 minus corrupti ullam facere omnis exercitationem necessitatibus nobis veritatis
                                  rem harum optio id accusantium voluptate voluptatibus.
                            Doloremque asperiores illo cumque et beatae! Perferendis veniam amet,
                             nisi quaerat culpa aperiam dolorum. Illo explicabo molestias voluptas
                              labore assumenda, quod odio temporibus sunt similique. Dolorem temporibus
                               commodi consectetur quasi.
                            </p>
                        </div>
                    </div>
